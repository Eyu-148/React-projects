...
const FILTER_NAMES = Object.keys(FilterMap); // using Object.keys() to collect an array of filter options' names
...
const App:React.FC = () => {
  ...
  return (
    <div className="App">
      ...
      <TodoList tasks={tasks} editTasks={editTask} deleteTask={deleteTask} toggleTaskCompleted={toggleTaskCompleted}/>
    </div>
  );
}
